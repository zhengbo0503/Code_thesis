...
fprintf("[START] evecs_varying_cond\n");
...
savedata = 0;
if savedata
    save("../data/evecs_varying_cond.mat");
end

writecsv = 1;
if writecsv
    plotdata = table(kkappa(:), ...
        err_mpjacobi(:,1), err_jacobi(:,1), err_pjacobi(:,1), err_matlab(:,1), bound2(:,1), ...
        err_mpjacobi(:,2), err_jacobi(:,2), err_pjacobi(:,2), err_matlab(:,2), bound2(:,2), ...
        err_mpjacobi(:,3), err_jacobi(:,3), err_pjacobi(:,3), err_matlab(:,3), bound2(:,3), ...
        'VariableNames', {'kappa', ...
        'mp3_m3', 'jacobi_m3', 'mp2_m3', 'matlab_m3', 'bound_m3', ...
        'mp3_m4', 'jacobi_m4', 'mp2_m4', 'matlab_m4', 'bound_m4', ...
        'mp3_m5', 'jacobi_m5', 'mp2_m5', 'matlab_m5', 'bound_m5'});
    write_figure_csv("../data/evecs_varying_cond.csv", plotdata);
end
...
fprintf("[END] evecs_varying_cond\n");
