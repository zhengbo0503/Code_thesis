...
fprintf("[START] svecs_varying_cols\n");
...
savedata = 0;
if savedata
    save("../data/svecs_varying_cols.mat");
end
...
if writecsv
    ...
    write_figure_csv("../data/svecs_varying_cols.csv", plotdata);
end
...
if drawgraph
    ...
    for mode = 1:3
        ...
        hold on;
        loglog(nn,err_dgesvj(:,mode),'LineStyle','none','Marker','pentagram', 'Color', C2);
        loglog(nn,err_dgejsv(:,mode),'LineStyle','none','Marker','square', 'Color', C3);
...
fprintf("[END] svecs_varying_cols\n");
